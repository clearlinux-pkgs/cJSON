...
Version  : 1.7.15
Release  : 2
URL      : https://github.com/DaveGamble/cJSON/archive/v1.7.15/cJSON-1.7.15.tar.gz
Source0  : https://github.com/DaveGamble/cJSON/archive/v1.7.15/cJSON-1.7.15.tar.gz
...
%prep
%setup -q -n cJSON-1.7.15
cd %{_builddir}/cJSON-1.7.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630086662
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/cJSON-1.7.15/LICENSE %{buildroot}/usr/share/package-licenses/cJSON/7953915bb3c653fd23ba9a96cbacabf2c005fad6
cp %{_builddir}/cJSON-1.7.15/tests/unity/docs/license.txt %{buildroot}/usr/share/package-licenses/cJSON/82d0bcdf2087a772a9517374e2df993d85fb447e
pushd clr-build
%make_install
popd
