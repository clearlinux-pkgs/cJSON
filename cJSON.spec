...
Version  : 1.7.16
Release  : 3
URL      : https://github.com/DaveGamble/cJSON/archive/v1.7.16/cJSON-1.7.16.tar.gz
Source0  : https://github.com/DaveGamble/cJSON/archive/v1.7.16/cJSON-1.7.16.tar.gz
...
%prep
%setup -q -n cJSON-1.7.16
cd %{_builddir}/cJSON-1.7.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691703880
mkdir -p clr-build
pushd clr-build
